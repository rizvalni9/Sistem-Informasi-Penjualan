...
public class testReport extends javax.swing.JFrame {
    ...
    private rootdb koneksi2 = new rootdb();
    private ResultSet rs;
    
    private void showUp(){
        try{
                rs=koneksi2.adapter.executeQuery("SELECT DISTINCT idtrs FROM nota");
                while(rs.next()){
                    jComboBox1.addItem(rs.getString("idtrs"));
                }
            }catch(Exception e){
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        parameter.put("id_trs", jComboBox1.getSelectedItem().toString());
        try{
            String path = "src/reports/rpTrans.jrxml";
