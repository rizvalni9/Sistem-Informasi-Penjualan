...
public class frmreg extends javax.swing.JDialog {
    ...
    private String gender,finalDate;
    private pasgenchiper keyGen2 = new pasgenchiper();
    ...
    public frmreg(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        rooting.root();
        initComponents();
        datebirth.setDate(sekarang);
            ...
            try{
                ...
                if(result.next()){
                    ...
                    if(question==JOptionPane.YES_OPTION){
                        rooting.adapter.executeUpdate("INSERT INTO person VALUES('"+txtnm.getText()+"','"+txtshnm.getText()+"','"+gender+"',"
                            +"'"+txtplc.getText()+"','"+finalDate+"','"+txtusnm.getText()+"',"
                            +"'"+keyGen2.enkripsi(txtpass.getText())+"','"+"Karyawan"+"','"+txtmail.getText()+"')");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmreg dialog = new frmreg(new javax.swing.JFrame(), true);
