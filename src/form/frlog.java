...
public class frlog extends javax.swing.JFrame{
    ...
    private pasgenchiper hashGen = new pasgenchiper();
    ...
    private void initComponents() {
        ...
        lbtext.setText("Lupa password? Silahkan klik :");
        body.add(lbtext, new org.netbeans.lib.awtextra.AbsoluteConstraints(29, 180, 160, -1));

        lbclickreg.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        lbclickreg.setText("Reset");
        lbclickreg.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                lbclickregMouseClicked(evt);
            }
        });
        body.add(lbclickreg, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 180, -1, -1));
    ...
    private void btnlogActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnlogActionPerformed
        if(txtid.getText().equals("USERNAME") || txtpass.getText().equals("PASSWORD")){
            ...
            String hashPass = hashGen.enkripsi(txtpass.getText());
            try{
                result = con.adapter.executeQuery("SELECT * FROM person WHERE id = '"+txtid.getText()+"' OR pass = '"+hashPass+"'");
                if(result.next()){
                    if(!txtid.getText().equals(result.getString("id"))){
                        ...
                        txtid.setText("");
                        txtid.requestFocus();
                    }else if(!hashPass.equals(result.getString("pass"))){
